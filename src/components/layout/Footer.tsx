...
export function Footer({ locale, common }: { locale: Locale; common: Common }) {
  ...
  return (
    <footer className="bg-ink text-parchment on-ink" role="contentinfo">
      <Container width="wide">
        <div className="grid gap-16 py-24 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-12 lg:py-32">
          <div className="flex max-w-[38ch] flex-col gap-6">
            ...
            <p className="t-body text-[0.9375rem] text-parchment/70">
              ...
              {routes.map((route) => (
                <li key={route.key}>
                  <Link
                    ...
                    className="text-[0.9375rem] text-parchment/80 transition-colors duration-200 [transition-timing-function:var(--ease)] hover:text-parchment"
                  >
          ...
          <div className="flex flex-col gap-5">
            ...
            <address className="flex flex-col gap-2 text-[0.9375rem] not-italic text-parchment/80">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1">
              <p className="t-figure-sm text-parchment">
                <Fact id="cherryPriceCurrent" />
              </p>
              <p className="t-meta text-parchment/60">Per kg cherry</p>
            </div>
        ...
        <div className="flex flex-col gap-4 border-t border-parchment/15 py-10 text-[0.8125rem] text-parchment/60 sm:flex-row sm:items-center sm:justify-between">
          <p>
