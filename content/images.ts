...
export const images = {
  ...
  lotAA: {
    ...
    minHeight: 1600,
    direction:
      'Square flat-lay of AA green beans on parchment paper, raking side light so bean size and uniformity read clearly. Beans fill the frame, centred, with even margins. Identical setup, light, height and crop for all four grade shots — they sit side by side in a grid and any difference in framing shows.',
    alt: 'Grade AA green coffee beans from Gathaithi, screen 17 and above.',
    sizes: '(min-width: 1024px) 30vw, 100vw',
  },
  lotAB: {
    file: 'lot-ab-green-beans.jpg',
    page: 'Our Coffee',
    section: 'Lot catalogue — AB',
    ratio: '1/1',
    minWidth: 1600,
    minHeight: 1600,
    direction: 'As lot-aa-green-beans.jpg, identical setup. AB beans.',
    alt: 'Grade AB green coffee beans from Gathaithi, screen 15 to 16.',
    sizes: '(min-width: 1024px) 30vw, 100vw',
  },
  lotPB: {
    file: 'lot-pb-green-beans.jpg',
    page: 'Our Coffee',
    section: 'Lot catalogue — PB',
    ratio: '1/1',
    minWidth: 1600,
    minHeight: 1600,
    direction: 'As lot-aa-green-beans.jpg, identical setup. Peaberry — the round single seeds should be obvious.',
    alt: 'Peaberry green coffee beans from Gathaithi.',
    sizes: '(min-width: 1024px) 30vw, 100vw',
  },
  lotC: {
    file: 'lot-c-green-beans.jpg',
    page: 'Our Coffee',
    section: 'Lot catalogue — C',
    ratio: '1/1',
    minWidth: 1600,
    minHeight: 1600,
    direction: 'As lot-aa-green-beans.jpg, identical setup. Grade C beans.',
    alt: 'Grade C green coffee beans from Gathaithi.',
    sizes: '(min-width: 1024px) 30vw, 100vw',
  },
  processPulping: {
